...
import com.server.listener.ConnectListener;
import com.server.listener.DataListener;
import com.server.store.RedissonStoreFactory;
import com.server.store.pubsub.ConnectMessage;
import com.server.store.pubsub.PubSubListener;
import com.server.store.pubsub.PubSubType;
...
//                System.out.println(com.server.getClient(UUID.fromString(data.getSessionId())));
            }
        });
